...
INSERT INTO `announcements` (`id`, `title`, `message`, `news_image`) VALUES
(1, 'Grand Launch', ' We’re building a Memorial Park to honor Canadian and Indian WWI soldiers. Phase 2 includes the monument, trails, signs, and amenities. Phase 1 is complete. Follow our progress and donate.', 'grandlaunch-icon.svg'),
(2, 'Fundraising Campaign', 'Help Build the Memorial\nSupport the construction of the monument, walking trails, and rest areas. Every donation helps honor 2.4 million soldiers. Let’s build this tribute together.', 'fundraising-icon.svg'),
(3, 'Volunteer with Us', 'Join our team to develop the park, work on trails and signs, assist with fundraising, and share stories. No experience needed, just a passion for honoring their memory. Contact us to get involved.', 'volunteer-icon.svg'),
(4, 'Thank You for Remembering', 'Visiting the Memorial honors WWI soldiers. Explore the site, read their stories, and donate to help complete the Memorial. Thank you for keeping their memory alive.', 'thankyou-icon.svg');
